...
ENGINES = ("google", "google-medical", "handoff")
...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        choices=ENGINES,
        help=(
            "google: plain Google Translate. google-medical: Google Translate plus "
            "a curated English-Vietnamese medical/rehabilitation glossary "
            "(pdf2zh/medical_glossary.py) that overrides Google's word choice for "
            "known clinical terms. handoff: hand segments to an AI agent."
        ),
    )
    parser.add_argument(
        "--segments",
