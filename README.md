...
- **Ngữ cảnh y khoa:** bật tuỳ chọn **Ngữ cảnh y khoa** để áp dụng từ điển thuật ngữ y khoa/phục hồi chức năng Anh-Việt có sẵn, ghi đè cách dịch chung chung của Google cho các thuật ngữ chuyên ngành.
...
| **Google Medical** | `translate.google.com` + [từ điển y khoa](pdf2zh/medical_glossary.py) | Tài liệu y khoa/phục hồi chức năng, vẫn cần nhanh và miễn phí |
| **Handoff** | AI agent trong phiên làm việc | Tài liệu chuyên ngành cần bản dịch theo ngữ cảnh sâu hơn từ điển cố định |

Google là chế độ mặc định và cũng là chế độ được dùng trong app desktop (kèm tuỳ chọn bật từ điển y khoa qua ô **Ngữ cảnh y khoa**). Google Medical dùng đúng request như Google nhưng thay các thuật ngữ y khoa/phục hồi chức năng đã biết bằng bản dịch tiếng Việt cố định trước khi gửi đi, nên không tốn thêm thời gian hay chi phí. Handoff trích các đoạn văn sang JSONL để agent dịch, sau đó dựng lại PDF; dữ liệu không được gửi tới Google nhưng sẽ tốn token và mất nhiều thời gian hơn.
